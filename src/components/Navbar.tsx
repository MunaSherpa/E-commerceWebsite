...
//             <Button color='inherit'onClick={() => handleNavigate('/register')}>Register</Button>
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
      ...
      <List>
        {navItems.map((item) => (
          <ListItem key={item} disablePadding>
            <ListItemButton sx={{ textAlign: 'center' }} onClick={() => handleNavigate(`/${item.toLowerCase()}`)}>
              <ListItemText primary={item} />
            </ListItemButton>
          </ListItem>
        ))}
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar component="nav">
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
            {navItems.map((item) => (
              <Button key={item} sx={{ color: '#fff' }} onClick={() => handleNavigate(`/${item.toLowerCase()}`)}>
                {item}
              </Button>
            ))}
